...
@section('content')
    <div class="container">
        <div class="mx-auto flex w-screen bg-white p-5 text-center flex-col">
            <div class="font-bold text-xl">Pet Adoption FAQs</div>
            <div class="text-base"><br>Get all the informations that you need<br>for your adoption</div>
            <a href="/faq"
                class="w-1/4 self-center mt-5 rounded-lg bg-[#043B5C] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-gray-800 border-black">LEARN
                MORE</a>
        </div>
